...
const InstructorProfile = () => {
  ...
  headers: { 
    Authorization: `Bearer ${localStorage.getItem("token")}` // This is the missing piece
  }
});
    ...
    try {
      ...
      if (formData.newPassword) {
        ...
        if (!formData.oldPassword) {
          alert("Please provide your old password to authorize changes.");
          return;
        }
      }
      ...
      // CHANGE THIS LINE: Change /update to /profile
      ...
      // This will now catch the correct error message if something fails
  ...
  const styles = {
    pageWrapper: { 
      width: "83vw", 
      minHeight: "100vh", 
      marginLeft: "235px", // Fixed: Ensured string format
      marginTop: "100px",  // Fixed: Ensured string format
    ...
    mainContent: { flex: 1, backgroundColor: "#17276B", padding: "40px", display: "flex", flexDirection: "column" },
  ...
  if (loading) return <div style={{ color: "white", textAlign: "center", padding: "100px", fontSize: "24px" }}>Loading Instructor Profile...</div>;
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={styles.layoutBody}>
        ...
        <main style={styles.mainContent}>
          <div style={styles.headerRow}><span style={{ fontSize: "28px" }}>👤</span><h2 style={{ margin: 0, fontSize: "28px" }}>Profile</h2></div>
                  ...
                  {[
                    ...
                    <div key={item.key} style={styles.settingsRow}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "10px", borderBottom: "1px solid #999" }}>
                        <input type="text" name={item.key} value={formData[item.key] || ""} onChange={handleChange} style={styles.inlineInput} />
